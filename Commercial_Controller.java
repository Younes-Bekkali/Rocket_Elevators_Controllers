...
public class elevator {
	...
	// not working//
	    ...
	    public class Elevator
	    {
	        ...
	        public ArrayList elevFloorsList ;
	        public Boolean  doorsSensor;
	        public Boolean weightCapacitySensor;
	        ...
	        public Elevator(int elevatorId, String status, int ElevCurrentFloor, String elevDirection)
	        {
	            ...
	            this.elevFloorsList = new ArrayList();
	        }
	        ...
	        public void moveElevator(int RequestedFloor, int columnId) throws InterruptedException
	        {
	            ...
	            // if the destination is below the elevators current position of the elevator
	            {
	                ...
	                status = "Moving";
	                System.out.println(" ");
	                System.out.println("Buttons' light off");
	                System.out.println(" ");
	                System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++");
	                System.out.println("Column # " + columnId + " Elevator # " + this.elevatorId + " " + status);
	                System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++");
	                System.out.println(" ");
	        ...
	        public void closeDoors() throws InterruptedException
	        {
	            if (doorsSensor || weightCapacitySensor)
	            {
	                ...
	                Thread.sleep(700);
	                System.out.println("Doors: Not obstructed");
	            ...
	            {
	                openDoors();
	                System.out.println("Doors: Obstructed");
	            }
	            else if (doorsSensor || weightCapacitySensor == false)
	            {
	                openDoors();
	                System.out.println("Elevator's weight capacity reached");
	            }
	            else
	            {
	                openDoors();
	        ...
	        public void moveUp(int RequestedFloor, int columnId) throws InterruptedException
	        {

	            System.out.println("Column # " + columnId + " || Elevator # " + elevatorId + " ||  Current Floor # " + this.ElevCurrentFloor);
	            System.out.println(" ");
	            Thread.sleep(700);
	            System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++");
	            ...
	            while (this.ElevCurrentFloor != RequestedFloor)
	            {
	                ...
	                System.out.println("Column # " + columnId + " || Elevator # " + elevatorId + " ||  Floor # " + this.ElevCurrentFloor);
	                Thread.sleep(300);
	            }
	        }

	        public void moveDown(int RequestedFloor, int columnId) throws InterruptedException
	        {
	            System.out.println("Column # " + columnId + " || Elevator # " + elevatorId + " ||  Current Floor # " + this.ElevCurrentFloor);
	            System.out.println(" ");
	            Thread.sleep(700);
	    ...
	    public class BatteryController
	    {
	        ...
	        public Elevator AssignElevator_ToFloors(int RequestedFloor)
	        {
	            ...
	            System.out.println(" ");
	            System.out.println("The user request the floor # " + RequestedFloor);
	            Thread.sleep(200);
	            System.out.println("Button's light turned to illuminated");
	        ...
	        public Elevator RequestElevator_ToGround(int FloorNumber, int RequestedFloor)
	        {
	            ...
	            System.out.println("Call an elevator to floor # " + FloorNumber);
	            System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++");
	            Thread.sleep(200);
	            System.out.println("Call button light's illuminated");
	            System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++");
	            ...
	            System.out.println(" ");
	            System.out.println("Button's light turned off");
	            // Return an elevator
	            return elevator;
	        }
	    ...
	    public class TestScenarios
	    {
	        public static void Main(String[] args)
	        {
	            ...
	            { 
	                System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
	                System.out.println("");
	                System.out.println("             ---Senarios Testing--- ");
	                System.out.println("");
	                System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
	                 System.out.println("");
	                System.out.println("Want you test a scenario? y/n (yes/No)");
	                ...
	                if (continueTesting == "n"){
	                    System.out.println("You choose to leave the test!");
	                    System.out.println("The test is done.");
	                    System.out.println("Thank you!");
	                    break;
	                }
	                 System.out.println("");
	                System.out.println("Please choose a scenario: 1, 2, 3 or 4");
	                ...
	                if (scenario == "1")
	                {
	                    ...
	                    System.out.println("");
	                    System.out.println("---Test scenario 1 : Ok++");
	                    System.out.println("");
	                    System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
	                ...
	                else if (scenario == "2")
	                {
	                    ...
	                    controller.AssignElevator_ToFloors(36);
	                     ...
	                     System.out.println("");
	                    System.out.println("---Test scenario 2 : Ok++");
	                    System.out.println("");
	                    System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
	                ...
	                else if (scenario == "3")
	                {
	                    ...
	                    Elevator elevator = controller.RequestElevator_ToGround(54, 1);
	                     ...
	                     System.out.println("");
	                    System.out.println("---Test scenario 3 : Ok++");
	                    System.out.println("");
	                    System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
	                ...
	                else if (scenario == "4")
	                {
	                    ...
	                    //controller.AssignElevator_ToBasements(1);
	                     ...
	                     System.out.println();
	                    System.out.println("---Test scenario 1 : Ending");
	                    System.out.println("");
	                    System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
